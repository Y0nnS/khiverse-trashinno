...
import { AlertTriangle, Battery, ChevronDown, ChevronRight, Globe, HardHat, Leaf, Lightbulb, Recycle, Sparkles } from 'lucide-react';
  ...
  const InteractiveCard = ({ icon, title, desc, examples, color, index }: any) => {
    return (
      <motion.div
        ...
        className={`p-5 rounded-xl shadow-md border-t-4 ${color.split(' ')[0]} border-opacity-80 relative overflow-hidden hover:shadow-lg transition-all`}>
        ...
        <div className="text-xs p-2 bg-white rounded-lg text-gray-600 relative z-10">
    ...
    return (
      <motion.div
        ...
        <div className="flex-shrink-0 flex items-start">
          <div className="bg-green-100 text-green-800 w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold">
            {step}
          </div>
        </div>
        <div className="flex-grow">
          ...
          <div className="mt-4 text-green-500 flex items-center gap-1 text-sm">
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 relative">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-16">
            ...
            <motion.div
              ...
              <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-200 relative z-10">
      ...
      <section className="bg-green-50 py-16 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 relative">
          ...
          <motion.div
            ...
            <h3 className="text-lg sm:text-2xl font-bold mb-4 relative z-10">
              Mulai Perjalanan Pengelolaan Sampah Anda
            </h3>
            <p className="text-sm sm:text-base mb-6 max-w-2xl mx-auto relative z-10">
